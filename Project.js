...
function toggleBackground() {
    ...
    var button = document.getElementById("backgroundToggle");

    body.classList.toggle("no-background");

    if (body.classList.contains("no-background")) {
        button.textContent = "Background: Off";
    } else {
        button.textContent = "Background: On";
    }
}
...
function undoChoice() {
    ...
    currentScene = lastStep.currentScene;
    broughtLakshmana = lastStep.broughtLakshmana;
    receiptScenes = lastStep.receiptScenes;
    receiptChoices = lastStep.receiptChoices;
